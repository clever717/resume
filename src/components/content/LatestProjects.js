                ...
                <div className="section-inner">
                    ...
                    <div className="content">
                        ...
                        <div className="item featured text-center">
                            <h3 className="title">
                                <a href="https://allwinair.com" target="_blank">ALLWIN AIR</a>
                            </h3>
                            <p className="summary">B2B Platform Service</p>
                            <div className="featured-image has-ribbon">
                                <a href="https://allwinair.com" target="_blank">
                            ...
                            <a className="btn btn-cta-secondary"
                               ...
                               target="_blank"><i className="fas fa-thumbs-up"></i> Back my project</a>
                        </div>
                        <hr className="divider"/>
                        <div className="item row">
                            <a className="col-md-4 col-12" href="https://www.jautour.com" target="_blank">
                                <img className="img-fluid project-image" src={jautour} alt="jautour"/>
                            </a>
                            <div className="desc col-md-8 col-12">
                                <h3 className="title">
                                    <a href="https://www.jautour.com" target="_blank">자유투어 - 개발/유지보수</a>
                                </h3>
                                <p className="mb-2">
                        ...
                        <div className="item row">
                            <a className="col-md-4 col-12" href="https://www.krt.co.kr" target="_blank">
                                <img className="img-fluid project-image" src={krt} alt="krt"/>
                            </a>
                            <div className="desc col-md-8 col-12">
                                <h3 className="title">
                                    <a href="https://www.krt.co.kr" target="_blank">KRT - 개발/유지보수</a>
                                </h3>
                                <p className="mb-2">
                                    - B2C/B2B 항공 예약 시스템 구축<br/>
                                    - 인벤토리 시스템 구축<br/>
                        ...
                        <div className="item row">
                            <a className="col-md-4 col-12" href="https://www.lottetour.com" target="_blank">
                                <img className="img-fluid project-image" src={lotte} alt="lottetour"/>
                            </a>
                            <div className="desc col-md-8 col-12">
                                <h3 className="title">
                                    <a href="https://www.lottetour.com" target="_blank">롯데투어 - 개발/유지보수</a>
                                </h3>
                                <p className="mb-2">
                                    - B2C/B2B 항공 예약 시스템 구축<br/>
                                    - 인벤토리 시스템 구축<br/>
                        ...
                        <div className="item row">
                            <a className="col-md-4 col-12" href="https://store.naver.com/flights/" target="_blank">
                                <img className="img-fluid project-image" src={naver} alt="naver"/>
                            </a>
                            <div className="desc col-md-8 col-12">
                                <h3 className="title">
                                    <a href="https://store.naver.com/flights/" target="_blank">네이버 - 개발/유지보수</a>
                                </h3>
                                <p className="mb-2">
                        ...
                        <div className="item row">
                            <a className="col-md-4 col-12" href="https://m.priviatravel.com" target="_blank">
                                <img className="img-fluid project-image" src={privia} alt="privia"/>
                            </a>
                            <div className="desc col-md-8 col-12">
                                <h3 className="title">
                                    <a href="https://m.priviatravel.com" target="_blank">현대카드 프리비아(모바일) - 개발/유지보수</a>
                                </h3>
                                <p className="mb-2">
                        ...
                        <div className="item row">
                            ...
                            <div className="desc col-md-8 col-12">
                                <h3 className="title">
                                    <a href="http://air.auction.co.kr/au/init/lp/lpMain.do" target="_blank">이베이(옥션/지마켓/G9)
                                        - 개발/유지보수</a>
                                </h3>
                                <p className="mb-2">
                        ...
                        <div className="item row">
                            <a className="col-md-4 col-12" href="https://www.priviatravel.com" target="_blank">
                                <img className="img-fluid project-image" src={privia} alt="privia"/>
                            </a>
                            <div className="desc col-md-8 col-12">
                                <h3 className="title">
                                    <a href="https://www.priviatravel.com" target="_blank">현대카드 프리비아 - 개발/유지보수</a>
                                </h3>
                                <p className="mb-2">
                                    - B2C 항공 예약 시스템 구축<br/>
